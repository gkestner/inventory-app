                  ...
                  <details key={t.id} style={{ borderTop: border, paddingTop: 10 }}>
                    ...
                    <div style={{ marginTop: 10, display: "grid", gap: 12 }}>
                      ...
                      <form action={updatePermissionsAction} style={{ display: "grid", gap: 8 }}>
                        ...
                        <div style={{ fontSize: 12, opacity: 0.8 }}>
                          Check the permissions this title grants. Users assigned this title inherit them.
                        </div>
                        ...
                        >
                          {allPermissions.map((perm) => (
                            ...
                            >
                              <input type="checkbox" name="permissions" value={perm} defaultChecked={selected.has(perm)} />
